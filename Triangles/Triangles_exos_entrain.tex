...
\begin{center}
\begin{tikzpicture}
\draw [thick](0,0) node [above left]{A}--(2,2.5) node [above]{C}--(4.4,-1) node[right] {B}--cycle;
\end{tikzpicture}
 
\vspace{1em}
\begin{tikzpicture}
\draw [thick](0,0) node [above left]{E}--(2,1) node [above]{D}--(4.4,-1) node [right] {F}--cycle;
\end{tikzpicture}
\end{center}
\vspace{1em}
\end{exercice}
...
\begin{center}
\begin{tikzpicture}
\draw [thick](0,0) node [above left]{B}--(2,2.5) node [above]{A}--(4.4,-1) node[right] {C}--cycle;
\end{tikzpicture}
...
\coordinate (G) at (0,0);
\coordinate (L) at (3.5,-2);
\draw [thick](G) node [above left]{G}--(L) node [below]{L}--([turn]90:3) node[right] {H}--cycle;
\draw [thick](G)--(L)--([turn]90:0.4)--([turn]90:0.4)--([turn]90:0.4); 
\end{tikzpicture}
\end{center}
\vspace{2em}
\end{exercice}
...
\begin{exercice}[trouver le centre du cercle]
