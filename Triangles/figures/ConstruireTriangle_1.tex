...
\begin{scope}[shift={(\DecalX,\DecalY)},rotate=\Rotation,scale=1]
    ...
    node[font=\tiny, rotate=\Rotation] (\a) at (\a,0.1){\a};}%ici rajouter l'angle de rotation de la figure complète pour que les nombres soient écrits correctement
\end{scope}
...
\draw[thick] (0,0) node [above left]{K}--(6,0) node[above right]{L};
