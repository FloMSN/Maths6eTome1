...
\newcommand{\prof}[1]{
        \ifthenelse{
                ...
                \vspace{12pt}\includegraphics[angle=0,width=1.5cm]{./Images/prof} \textbf{Professeur :} \textsl{#1}
...
\themaC
\include{NombresEntiersDecimaux/NbEntiersDecimaux}

\themaC
\include{OperationsNombresEntiersDecimaux/OpNbEntDec}
